...
export function Menu() {
  ...
  return (
    <Menubar className="rounded-none bg-inherit border-b border-none px-2 lg:px-4 justify-between">
        ...
        <div className="flex items-center">
          {/* <Link href={"/"}>
            <Image
              ...
              width={50}
              height={50}
              alt="Startup Assistant"
              className="h-10 w-10 block md:hidden"
            />
          </Link> */}

          <Link href="/" className="block items-center space-x-2 md:hidden">
      ...
      <div className="flex">
        <DropdownMenu>
          <DropdownMenuTrigger asChild className="mr-3 flex md:hidden">
